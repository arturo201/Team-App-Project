...
onClick('new-team', () => {
    // Create a new Team object and add it to the teams array
    teams.push(new Team(teamId++, getValue('new-team-name')));
    drawDOM();
});

// Utility function to register a click event on an element
...
// Utility function to retrieve the value of an input element
function getValue(id) {
    return document.getElementById(id).value;
}

// Draw the teams and their members in the DOM
function drawDOM() {
...
// Create a new row for a team member in the team's table
...
// Create a "Delete" button for deleting a team member
...
// Create a "Delete Team" button for deleting a team
...
// Create a "Create" button for adding a new member to a team
...
// Create a table for displaying team members
...
// Utility function to clear an element's contents
